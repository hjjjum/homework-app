/* ---------------------------------------------------------------------------
 * stickers.js — 스티커 56종 (전부 CSS 도형 조합, 이미지 파일 없음)
...
export const GROUPS = ["고양이", "과일", "채소 · 간식", "디저트", "꽃 · 식물", "하늘 · 마음", "사물", "바느질 · 뜨개질"];
...
export const STICKERS = [
  ...
  /* ---------- 바느질 · 뜨개질 4종 (모두 얼굴 있음) ---------- */
  { id: "spool", name: "실패와 바늘", group: "바느질 · 뜨개질", parts: [].concat([
    // 바늘은 실패 뒤로 꽂혀 오른쪽 위로 삐죽 나온다 (회전은 부품 가운데 기준)
    P(62, 6, 5, 70, "#B8C4CC", "999px", null, 28),
    P(76.6, 12.8, 2, 7, "#FFF6EA", "999px", null, 28),
    // 실패에서 바늘귀로 이어지는 실 한 가닥
    P(69.5, 14.5, 2.5, 27.3, "#FF7FAE", "999px", null, 30),
    P(22, 26, 42, 54, "#FF7FAE", "6px"),
    P(27, 30, 6, 46, "#FFA3C6", "999px"),
    P(16, 17, 54, 13, "#D9A06B", "999px"), P(20, 18, 46, 6, "#EBC193", "999px"),
    P(16, 76, 54, 13, "#D9A06B", "999px")],
    EYES(34, 50, 44, 9, 11), BLUSH(28, 55, 58, 9, 5, "#FF5C99"),
    [P(41, 58, 6, 4, "#B03366", "0 0 999px 999px")]) },
  { id: "yarn", name: "털실 뭉치", group: "바느질 · 뜨개질", parts: [].concat([
    // 공 위로 V자로 꽂힌 뜨개바늘 두 개 + 동그란 꼭지
    P(37.5, 5, 5, 70, "#8FD9EE", "999px", null, -25), P(57.5, 5, 5, 70, "#8FD9EE", "999px", null, 25),
    P(19.7, 2.8, 11, 11, "#FF7FAE", "50%"), P(69.3, 2.8, 11, 11, "#FFC93C", "50%"),
    P(80, 82, 16, 5, "#A98BE8", "999px", null, 24),
    P(13, 27, 72, 70, "#A98BE8", "50%"),
    // 감긴 실 결: 공 밖에서 그린 둥근 줄무늬가 공 모양대로 잘린다
    P(13, 27, 72, 70,
      "radial-gradient(circle at 12% 112%,transparent 0 44%,#C7B0F2 45% 50%,transparent 51% 62%,#C7B0F2 63% 68%,transparent 69%)", "50%"),
    P(13, 27, 72, 70, "radial-gradient(circle at 104% 0%,transparent 0 40%,#8E6FD6 41% 45%,transparent 46%)", "50%")],
    EYES(34, 55, 56, 10, 12), BLUSH(26, 64, 70, 11, 6, "#F2A7C8"),
    [P(44, 71, 10, 5, "#6B4FB0", "0 0 999px 999px")]) },
  { id: "button", name: "단추", group: "바느질 · 뜨개질", parts: [].concat([
    P(8, 8, 84, 84, "#8FD9C0", "50%"),
    P(17, 17, 66, 66, "#74C7AB", "50%"),
    P(20, 13, 26, 10, "#D4F4E8", "999px", null, -32),
    // 구멍 네 개 + 엑스자로 꿰맨 실
    P(35, 28, 11, 11, "#3F8F74", "50%"), P(54, 28, 11, 11, "#3F8F74", "50%"),
    P(35, 47, 11, 11, "#3F8F74", "50%"), P(54, 47, 11, 11, "#3F8F74", "50%"),
    P(37, 41, 26, 4, "#FF7FAE", "999px", null, 45), P(37, 41, 26, 4, "#FF7FAE", "999px", null, -45)],
    [P(33, 64, 7, 8, "#2F2A33", "50%"), P(60, 64, 7, 8, "#2F2A33", "50%"),
     P(34.5, 65, 2.5, 2.5, "#FFFFFF", "50%"), P(61.5, 65, 2.5, 2.5, "#FFFFFF", "50%")],
    BLUSH(25, 68, 72, 9, 5, "#FFB3C7"),
    [P(46, 71, 8, 4, "#2F6E59", "0 0 999px 999px")]) },
  { id: "pincushion", name: "바늘꽂이", group: "바느질 · 뜨개질", parts: [].concat([
    // 머리가 동그란 시침핀 세 개 (쿠션 뒤로 꽂힌다)
    P(30, 8, 3, 30, "#B8C4CC", "2px", null, -20), P(48.5, 8, 3, 28, "#B8C4CC", "2px"),
    P(67, 8, 3, 30, "#B8C4CC", "2px", null, 20),
    P(20.4, 2.9, 12, 12, "#FFC93C", "50%"), P(44, 2, 12, 12, "#8FD9EE", "50%"),
    P(67.6, 2.9, 12, 12, "#B38CE0", "50%"),
    // 토마토 모양 쿠션
    P(8, 28, 84, 64, "#FF5B6E", "50%/55% 55% 45% 45%"),
    P(24, 36, 4, 44, "#F2707F", "999px", null, -14), P(72, 36, 4, 44, "#F2707F", "999px", null, 14),
    P(16, 38, 12, 7, "#FF8F9C", "999px", null, -24),
    P(34, 22, 32, 14, "#3FA86B", LEAF), P(46, 18, 8, 10, "#3FA86B", "3px")],
    EYES(33, 57, 52, 10, 12), BLUSH(22, 67, 68, 11, 6, "#FF9FAA"),
    [P(45, 70, 10, 5, "#B03328", "0 0 999px 999px")]) }
];
